...
// 上滑加载更多
  ...
  zan: function (e) {
    ...
    this.data.cards[i].show = true
    this.data.cards_test[i].show = true
    // var num = 0
    // var num = num + 1
    this.data.cards_test[i].num = this.data.cards_test[i].num + 1
    // this.data.cards[i].num = this.data.cards[i].num+ 1
    // 原数据
